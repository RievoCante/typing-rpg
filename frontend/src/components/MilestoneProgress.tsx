...
export default function MilestoneProgress({ completedQuotes, totalMilestones }: MilestoneProgressProps) {
  const { theme } = useThemeContext();
  
  // Ensure we don't exceed bounds
  const safeCurrentMilestone = Math.max(0, Math.min(completedQuotes, totalMilestones));
