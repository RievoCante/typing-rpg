...
export default function RecentSessionsModal({
  open,
  onClose,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden transition-colors duration-300 bg-[#1D1F2A] text-white dark:bg-[#303446] dark:text-gray-100">
            ...
            <ul className="divide-y divide-white/10">
              {sessions.map(s => (
                ...
                >
                  ...
                  <span className="capitalize opacity-90">{s.mode}</span>
