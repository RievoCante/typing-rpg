  ...
  return (
    <>
      <div className="relative max-w-3xl mx-auto mt-8">
        ...
        {/* Reset button - bottom right of the typing interface */}
        <button
          type="button"
          aria-label="Reset typing"
          title="Reset"
          onClick={initializeNewText}
          className="absolute bottom-4 right-4 z-10 rounded-full p-3 transition-colors bg-transparent text-gray-700 hover:bg-black/10 dark:text-gray-200 dark:hover:bg-white/10"
        >
          <RotateCcw size={18} />
        </button>
